...
import { Selector, DabbyNode, DabbyConstructor, Dabby} from './types.js';

// proxy dabby to make sure once properties are set, they cannot be overwritten
const $ = proxy(function dabby(dabby: DabbyConstructor, selector: Selector, context?: Selector) : Dabby {
