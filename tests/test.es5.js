...
QUnit.test("getVal", function (assert) {
  ...
  }, obj, 0), "test", "When passing function as value, variables and context is correct"); //assert.equal(internals.getVal(380, obj, 0), "380px", "Can return a number as a px value");
